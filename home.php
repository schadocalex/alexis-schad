   ...
   <section id="about">
      ...
      <div class="row">
         ...
         <div class="nine columns main-col">
            ...
            <p>
               Bonjour et bienvenue sur mon site ! Je suis Alexis Schad, élève ingénieur
               en Génie Informatique à l'Université de Technologie de Compiègne. <br/><br/>
               Je suis passionné par tout ce qui touche aux sciences, aux mathématiques,
               à l'ingénierie, à la robotique et plus généralement aux nouvelles technologies. <br/>
               Je participe de ce fait pour la troisième fois à la Coupe de France de Robotique.
               Ancien président de l'association de robotique de l'UTC, je suis désormais responsable Informatique et trésorier. Ce projet multi-disciplinaire m'a permis de développer considérablement mes compétences
               techniques en robotique - que ce soit en Informatique, en Electronique ou en Mécanique - ainsi
               qu'en gestion de projet.<br />
               Je suis également membre du FabLab de l'UTC et, en tant que responsable machines, je maitrîse
               l'impression 3D et la découpe laser.
            </p>
            ...
            <div class="row">
               ...
               <div class="columns download">
                  <p>
                     <a href="#" class="button"><i class="fa fa-download"></i>Télécharger mon CV (à venir)</a>
                  </p>
               </div>
   ...
   <section id="contact">
         ...
         <div class="row section-head">
            ...
            <div class="ten columns">
                  ...
                  <p class="lead">
                     Contactez-moi si vous avez des questions sur mon CV, sur mon blog, si un de mes projets vous intéresse ou si vous voulez simplement discuter.<br/>
                     Je suis par ailleurs à la recherche d'un stage de 6 mois à l'automne 2015.
                  </p>
            ...
            <div class="eight columns">
               ...
               <form action="" method="post" id="contactForm" name="contactForm">
                  ...
                  <div>
                     ...
                     <textarea cols="40" rows="5" id="contactMessage" name="contactMessage"></textarea>
                  </div>
